...
const forecast = (latitude, longitude, callback) => {
    ...
    const url = `http://api.weatherstack.com/current?access_key=c86b952bd99f8e889997f77aaf4d27fe&%20query=${encodeURIComponent(latitude)},${encodeURIComponent(longitude)}`;
    console.log(url)
